  ...
  <div class="row">
    ...
    <div class="section container">
        ...
        <div class="input-field col s6 m4">
            ...
            <a href="../app/reports/todospagos.php" target="_blank" class="btn waves-effect amber tooltipped" data-tooltip="Reporte de Pagos por Tipo"><i class="material-icons">assignment</i></a>
        </div>
    </form>
    </div>
    </div>
